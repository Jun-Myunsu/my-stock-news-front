...
import { sendChatMessage, testGeminiConnection, uploadToNotion } from "../api/chat";
import type { ChatMessage } from "../types/chat";
import { PaperAirplaneIcon, TrashIcon, DocumentArrowUpIcon } from "@heroicons/react/24/outline";
    ...
    <div className="border rounded-lg shadow overflow-hidden bg-white dark:bg-gray-800 border-gray-200 dark:border-gray-700 h-[95vh]">
      <div className="bg-gray-100 dark:bg-gray-900/50 px-6 py-4 border-b dark:border-gray-700">
        <div className="flex justify-between items-center">
          <div>
            <h2 className="text-2xl font-bold text-gray-900 dark:text-gray-100">🤖 AI 주식 상담</h2>
        ...
        <div className="border-t dark:border-gray-700 p-4 relative">
          {showPrompts && (
            <div className="absolute bottom-full left-4 right-4 mb-2 z-10">
              <QuickPrompts onPromptSelect={handlePromptSelect} registeredStocks={registeredStocks} />
            </div>
          )}
